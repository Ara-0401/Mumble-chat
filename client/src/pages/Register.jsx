...
<div className="flex items-center justify-center bg-[#1f1f1f] text-[#e5e5e5] h-screen w-screen ">
    <div className="p-8  w-[380px]  h-[460px] shadow-lg bg-[#2a2a2a]  border border-[#3a3a3a] rounded-2xl">
     <div className="mb-6">
        <h1 className="text-2xl font-semibold flex items-center gap-2">
         ...
         Mumble
           ...
           <p className="text-[#a1a1a1] text-sm m-1">sign into your account</p>
            ...
            <div className="mb-4" >
                <label className="text-sm text-[#a1a1aa] block mb-1"> Name  </label>
                    <input
            ...
            <button className="w-full py-2 rounded-lg bg-[#3a3a3a] hover:bg-[#4a4a4a] transition" onClick={handleSubmit}> Register</button>
            <p className="text-center text-sm text-[#a1a1aa] mt-4">  Already have an Acoount?
                <span className="text-[#8b5cf6] cursor-pointer hover:underline" onClick={handleLogin}> Login</span>
            </p>
